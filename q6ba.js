...
Qualtrics.SurveyEngine.setEmbeddedData('q6bb_number', number)                              
...
var randNumber = Qualtrics.SurveyEngine.getEmbeddedData('q6ba_number')
...
{
	Qualtrics.SurveyEngine.setEmbeddedData('q6ba_answer',1)
	console.log('result of the question is True')
}
else 
{
	Qualtrics.SurveyEngine.setEmbeddedData('q6ba_answer',0)
