...
Qualtrics.SurveyEngine.setEmbeddedData('qs8_minuend', minuend)                              
Qualtrics.SurveyEngine.setEmbeddedData('qs8_subtrahend', subtrahend)
Qualtrics.SurveyEngine.setEmbeddedData('qs8_result', result)
...
var result = Qualtrics.SurveyEngine.getEmbeddedData('qs8_result')


/*check if the number variable is the same as the currentResponse variable*/
if(currentResponse == result)
{
	Qualtrics.SurveyEngine.setEmbeddedData('qs8_answer',1)
	console.log('result of the question is True')
}
else 
{
	Qualtrics.SurveyEngine.setEmbeddedData('qs8_answer',0)
