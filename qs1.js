...
Qualtrics.SurveyEngine.setEmbeddedData('qs1_minuend', minuend)                              
Qualtrics.SurveyEngine.setEmbeddedData('qs1_subtrahend', subtrahend)
Qualtrics.SurveyEngine.setEmbeddedData('qs1_result', result)
...
var result = Qualtrics.SurveyEngine.getEmbeddedData('qs1_result')


/*check if the number variable is the same as the currentResponse variable*/
if(currentResponse == result)
{
	Qualtrics.SurveyEngine.setEmbeddedData('qs1_answer',1)
	console.log('result of the question is True')
}
else 
{
	Qualtrics.SurveyEngine.setEmbeddedData('qs1_answer',0)
