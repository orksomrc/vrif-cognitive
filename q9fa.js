...
Qualtrics.SurveyEngine.setEmbeddedData('q9fa_number', number)                              
...
var randNumber = Qualtrics.SurveyEngine.getEmbeddedData('q9fa_number')                              

/*check if the number variable is the same as the currentResponse variable*/
if(currentResponse == randNumber)
{
	Qualtrics.SurveyEngine.setEmbeddedData('q9fa_answer',1)
	console.log('result of the question is True')
}
else 
{
	Qualtrics.SurveyEngine.setEmbeddedData('q9fa_answer',0)
