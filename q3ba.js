...
Qualtrics.SurveyEngine.setEmbeddedData('q3ba_number', number)                              
...
var randNumber = Qualtrics.SurveyEngine.getEmbeddedData('q3ba_number')
...
{
	Qualtrics.SurveyEngine.setEmbeddedData('q3ba_answer',1)
	console.log('result of the question is True')
}
else 
{
	Qualtrics.SurveyEngine.setEmbeddedData('q3ba_answer',0)
