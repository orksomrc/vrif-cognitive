...
Qualtrics.SurveyEngine.setEmbeddedData('q9ba_number', number)                              
...
var randNumber = Qualtrics.SurveyEngine.getEmbeddedData('q9ba_number')
...
{
	Qualtrics.SurveyEngine.setEmbeddedData('q9ba_answer',1)
	console.log('result of the question is True')
}
else 
{
	Qualtrics.SurveyEngine.setEmbeddedData('q9ba_answer',0)
