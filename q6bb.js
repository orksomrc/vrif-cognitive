...
var randNumber = Qualtrics.SurveyEngine.getEmbeddedData('q6bb_number')
...
{
	Qualtrics.SurveyEngine.setEmbeddedData('q6bb_answer',1)
	console.log('result of the question is True')
}
else 
{
	Qualtrics.SurveyEngine.setEmbeddedData('q6bb_answer',0)
