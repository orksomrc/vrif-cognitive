...
Qualtrics.SurveyEngine.setEmbeddedData('qs5_minuend', minuend)                              
Qualtrics.SurveyEngine.setEmbeddedData('qs5_subtrahend', subtrahend)
Qualtrics.SurveyEngine.setEmbeddedData('qs5_result', result)
...
var result = Qualtrics.SurveyEngine.getEmbeddedData('qs5_result')


/*check if the number variable is the same as the currentResponse variable*/
if(currentResponse == result)
{
	Qualtrics.SurveyEngine.setEmbeddedData('qs5_answer',1)
	console.log('result of the question is True')
}
else 
{
	Qualtrics.SurveyEngine.setEmbeddedData('qs5_answer',0)
