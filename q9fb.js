...
var newDiv = document.createElement('div');
	jQuery(newDiv).css({"width":"300px","height":"250px","padding-left":"1.5em"}).attr("id","newDiv");
...
Qualtrics.SurveyEngine.setEmbeddedData('q9fb_number', number)                              
...
var randNumber = Qualtrics.SurveyEngine.getEmbeddedData('q9fb_number')                              

/*check if the number variable is the same as the currentResponse variable*/
if(currentResponse == randNumber)
{
	Qualtrics.SurveyEngine.setEmbeddedData('q9fb_answer',1)
	console.log('result of the question is True')
}
else 
{
	Qualtrics.SurveyEngine.setEmbeddedData('q9fb_answer',0)
