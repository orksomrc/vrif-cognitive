...
Qualtrics.SurveyEngine.setEmbeddedData('q8fb_number', number)                              
...
var randNumber = Qualtrics.SurveyEngine.getEmbeddedData('q8fb_number')                              

/*check if the number variable is the same as the currentResponse variable*/
if(currentResponse == randNumber)
{
	Qualtrics.SurveyEngine.setEmbeddedData('q8fb_answer',1)
	console.log('result of the question is True')
}
else 
{
	Qualtrics.SurveyEngine.setEmbeddedData('q8fb_answer',0)
