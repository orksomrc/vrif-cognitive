...
Qualtrics.SurveyEngine.setEmbeddedData('q8bb_number', number)                              
...
var randNumber = Qualtrics.SurveyEngine.getEmbeddedData('q8bb_number')
...
{
	Qualtrics.SurveyEngine.setEmbeddedData('q8bb_answer',1)
	console.log('result of the question is True')
}
else 
{
	Qualtrics.SurveyEngine.setEmbeddedData('q8bb_answer',0)
