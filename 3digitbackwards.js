...
Qualtrics.SurveyEngine.setEmbeddedData('q3bb_number', number)                              
...
var time = 3500; //time in milliseconds after which number block disappears
...
var randNumber = Qualtrics.SurveyEngine.getEmbeddedData('q3bb_number')
...
{
	Qualtrics.SurveyEngine.setEmbeddedData('q3bb_answer',1)
	console.log('result of the question is True')
}
else 
{
	Qualtrics.SurveyEngine.setEmbeddedData('q3bb_answer',0)
